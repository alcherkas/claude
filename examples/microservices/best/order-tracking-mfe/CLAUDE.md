# CLAUDE.md — `order-tracking-mfe`

> Project-level agent context for **order-tracking-mfe**. Inherited **on top of** the workspace spine (`../CLAUDE.md`) and the canonical contract (`../PLATFORM_SPEC.md`). If anything here disagrees with the spec, **the spec wins**.

## What this repo is
Live order + delivery tracking.

- **Dev port:** `3003`  ·  **Module-Federation name:** `orderTracking`
...
## Cross-repo coupling
- **Talks to (via gateway):** `order-service`, `delivery-service`
