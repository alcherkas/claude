# CLAUDE.md — `discovery-mfe`

> Project-level agent context for **discovery-mfe**. Inherited **on top of** the workspace spine (`../CLAUDE.md`) and the canonical contract (`../PLATFORM_SPEC.md`). If anything here disagrees with the spec, **the spec wins**.

## What this repo is
Browse / search restaurants and menus.

- **Dev port:** `3001`  ·  **Module-Federation name:** `discovery`
...
## Cross-repo coupling
- **Talks to (via gateway):** `search-service`, `restaurant-service`, `menu-service`
