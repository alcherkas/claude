...
import com.quickbite.promotion.service.PromotionException;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Map<String, Object>> handlePromotion(PromotionException ex, HttpServletRequest request) {
