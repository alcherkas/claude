# CLAUDE.md — `driver-portal-mfe`

> Project-level agent context for **driver-portal-mfe**. Inherited **on top of** the workspace spine (`../CLAUDE.md`) and the canonical contract (`../PLATFORM_SPEC.md`). If anything here disagrees with the spec, **the spec wins**.

## What this repo is
Courier console: availability and active deliveries.

- **Dev port:** `3006`  ·  **Module-Federation name:** `driverPortal`
...
## Cross-repo coupling
- **Talks to (via gateway):** `driver-service`, `delivery-service`
