...
import com.quickbite.notification.event.EventEnvelope;
...
/**
 * Kafka consumer wiring for the three inbound topics ({@code orders.events},
 * {@code payments.events}, {@code deliveries.events}). Values are JSON {@link EventEnvelope}s.
 *
...
public class KafkaConfig {
    ...
    public ConsumerFactory<String, EventEnvelope> consumerFactory() {
        ...
        props.put(JsonDeserializer.TRUSTED_PACKAGES, "com.quickbite.notification.event");
    ...
    public ConcurrentKafkaListenerContainerFactory<String, EventEnvelope> kafkaListenerContainerFactory() {
        ...
        // 2 retries, 1s apart, then log-and-drop the record (also guarded by ErrorHandlingDeserializer).
