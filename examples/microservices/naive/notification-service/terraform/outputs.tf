...
output "ecr_repository_url" {
  description = "ECR repository to push the notification-service image to."
...
output "db_endpoint" {
  description = "notification_db RDS endpoint."
  value       = module.db.endpoint
}

output "db_secret_arn" {
  description = "Secrets Manager ARN holding the notification_db credentials."
